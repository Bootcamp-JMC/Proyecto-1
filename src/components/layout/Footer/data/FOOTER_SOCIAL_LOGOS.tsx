...
export const FOOTER_SOCIAL_LOGOS: FooterLogos[] = [
  {
    id: 1,
    logo: (
      <a
        href="#"
        className="flex h-10 w-10 items-center justify-center rounded-lg bg-gray-800 transition-colors hover:bg-purple-600"
      >
        <svg
